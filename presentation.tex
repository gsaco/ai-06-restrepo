...
\end{aligned}
\]
\small \key{Verdict:} the flat claim ``automation lowers both'' is false for wages; and even the labor-share decrease requires an effective, binding expansion of automated tasks.
\column{0.42\textwidth}
\centering\includegraphics[width=\linewidth,height=6.4cm,keepaspectratio]{hand/derivation.png}
\end{columns}
\end{frame}
