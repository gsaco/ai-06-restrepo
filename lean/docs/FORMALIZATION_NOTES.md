...
- Public PDF: https://www.nber.org/system/files/working_papers/w22252/w22252.pdf
...
|---|---|---|---|---|
| Equations (5)--(6), threshold cost ranking | `thresholdCostRanking` | checked support only | `ProofInterface.lean` | Global real-index assumptions stronger than active task interval; no equilibrium existence proof |
| Proposition 3 wage-sign implication | `automationWageSign` | checked support only | `ProofInterface.lean` | Wage decomposition supplied as definition; full proposition remains open |
